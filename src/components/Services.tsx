...
const Services: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1521590832167-d99d4ad6c5b8?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
      category: 'cortes'
    },
              ...
              <CardContent className="p-6">
                <div className="flex justify-between items-center">
                  ...
                  <button 
                    ...
                    className="text-primary font-semibold hover:text-primary/80 transition-colors duration-200 text-sm"
                  >
                    Ver más →
                  </button>
                </div>
